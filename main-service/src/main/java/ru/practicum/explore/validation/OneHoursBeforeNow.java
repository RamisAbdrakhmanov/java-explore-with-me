...
@Constraint(validatedBy = OneHoursBeforeNow.CustomDateValidator.class)
public @interface OneHoursBeforeNow {
    ...
    class CustomDateValidator implements ConstraintValidator<OneHoursBeforeNow, LocalDateTime> {
